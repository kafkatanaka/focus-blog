...
**Time investment**: 60-90 minutes initially to design your routine, then 30-90 minutes per morning (varies by your constraints and goals)
**Upfront cost**: $0-50 (possible purchases: coffee timer, blackout curtains, breakfast meal prep containers—all optional)
**Prerequisites**: 
...
Example log entry:
"6:45am - Check phone: 15 min, 0 decisions, 8 context switches (texts → news → email → social → news → email → texts → calendar), emotional arousal: 3 (saw stressful work email and political news)"
...
**If you only have 30 minutes total before first obligation**: 
Implement only Step 4 (phone quarantine) and Step 6 (start with hardest task immediately). Wake → bathroom → coffee → sit down and start focus work → 30 minutes later, access phone if needed. Every minute of your 30 minutes goes to deep work, not consumption. That's your entire system.

**If you only have $0**: 
Every element of focus-protecting morning is free. You need no apps, tools, or purchases. Using a timer on your phone (set before quarantine starts) or a kitchen timer costs nothing. Preparation of simple breakfast and laying out clothes the night before costs nothing. The system is free.

**If you only have evenings and weekends for focus**: 
...
**How to implement**: 
Identify the specific physiological and environmental conditions that create your absolute peak focus state, then engineer those conditions into every morning. Track for two weeks:
...
**How to implement**: 
Natural alertness follows ~90-minute ultradian cycles. Design your morning around these cycles rather than arbitrary time blocks:

**Cycle 1 (0-90 minutes after full wake)**: Highest focus—use for absolute hardest cognitive work
**Break (10-15 minutes)**: Movement, hydration, bathroom—no input consumption
**Cycle 2 (90-180 minutes after wake)**: Still high focus—use for second-hardest work
**Break (10-15 minutes)**: Light snack, movement, brief input check if needed
**Cycle 3 (180-270 minutes)**: Declining focus—use for moderate difficulty work or stop deep work here
...
**How to implement**: 
Create a 15-minute evening protocol that pre-loads tomorrow's focus work, minimizing morning friction:

**Evening protocol (before bed)**:
1. Identify tomorrow's single focus task (most important deep work)
2. Open relevant files/documents and leave them visible on screen or desk
3. Write 3-sentence plan for how to start the task (removes morning decision-making)
4. Lay out clothes, prep breakfast, prep coffee
5. Set environment for morning (dim lights, position chair, queue brown noise playlist)
6. Write transition ritual reminder ("Tomorrow: light candle, sit, start Section 3 of report")
7. Final phone check, then phone goes to quarantine location
...
**How to know it's broken vs just harder**: 
Harder means you're still starting focus work before checking phone/email, but it feels more effortful. Broken means you've reverted to checking phone immediately upon waking and haven't done a focus block in 7+ days.

**When it's broken, do this**:
1. **Don't try to resume your full routine**—return to absolute minimum: wake → bathroom → coffee → 30 minutes of focus work. That's it. Rebuild from there.
2. **Re-audit your morning** (Step 1)—what changed? New job? Kids' schedule shift? Relationship change? Sleep disruption? You need to redesign for new conditions, not force old routine.
3. **Verify your focus peak hasn't shifted**—sometimes life changes or age shift your chronotype. Re-test whether morning is still your peak, or whether you need to optimize for afternoon/evening now.
4. **Identify which element broke first**—was it phone quarantine? Decision elimination? Focus block discipline? Fix the specific weak point, not the entire system.
5. **Lower your standards temporarily**—if you were doing 90-minute focus blocks, restart with 30-minute blocks. You're rebuilding capacity, not resuming peak performance.
